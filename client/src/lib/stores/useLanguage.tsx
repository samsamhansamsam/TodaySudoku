...
const koStrings: Record<string, string> = {
  ...
  'Player': '플레이어',
  'Time': '시간',
  'Daily puzzle for': '날짜별 퍼즐',
  'Pick a date': '날짜 선택',
  'No records yet. Be the first to set a record!': '아직 기록이 없습니다. 첫 기록을 세워보세요!',
  'Leaderboard resets at midnight UTC': '리더보드는 자정(UTC)에 초기화됩니다',
  'Resets in': '초기화까지',
  'Showing historical data for': '다음 날짜의 기록',
